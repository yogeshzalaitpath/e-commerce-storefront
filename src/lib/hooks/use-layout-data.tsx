...
import { ExtendedPricedProduct, ProductPreviewType } from "types/global"
...
const fetchFeaturedProducts = async (
  ...
  const products: ExtendedPricedProduct[] = await getProductsList({
    pageParam: 0,
    queryParams: {
      limit: 4,
      cart_id: cartId,
    ...
    .catch((_) => [] as ExtendedPricedProduct[])
